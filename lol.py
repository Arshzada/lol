...
if 'aarch64' in str(current_os):
    ...
    if not os.path.isfile('t64'):
        ...
        os.system('curl -L https://github.com/tcoder99/lib/blob/main/for-termux/aarch64/t64?raw=true > t64')
    ...
    if not os.path.isfile('t32'):
        ...
        os.system('curl -L https://github.com/tcoder99/lib/blob/main/for-termux/arm/t32?raw=true > t32')
